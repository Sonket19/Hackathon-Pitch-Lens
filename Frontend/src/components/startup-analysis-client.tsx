...
interface StartupAnalysisClientProps {
  startupId: string;
}

export default function StartupAnalysisClient({
  startupId,
}: StartupAnalysisClientProps) {
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-20">
            ...
            <p className="text-muted-foreground mt-2">
              Our AI is hard at work. This might take a moment.
            </p>
          </div>
        ) : error ? (
              ...
              return (
                <div className="text-center py-20">
                  ...
                  <p className="text-muted-foreground mt-4">
                    {metadataError ||
                      'Please try regenerating the summary once the underlying issue is resolved.'}
                  </p>
                </div>
              );
            }
              ...
              <>
                {!hasMemo && pollTimedOut ? (
                  <div className="mb-6 rounded-lg border border-dashed border-muted-foreground/40 bg-muted/40 p-4 text-sm text-muted-foreground">
                    We&apos;re still waiting for the memo to finish generating. The dashboard will update automatically when it&apos;s ready, but you can also try generating the summary manually below.
                  </div>
                ) : null}
                <AnalysisDashboard
          ...
          <div className="text-center py-20">
            <h2 className="text-2xl font-headline font-semibold text-muted-foreground">
